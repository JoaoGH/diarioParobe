...
<html class="no-js">
    ...
    <body id="top">
        ...
        $qSobre = "SELECT capa,texto FROM fixos WHERE pagina='Sobre'";
        ...
        <section class="s-content s-content--narrow">
            ...
            <div class="row">
                ...
                <div class="col-full s-content__main">
                    ...
                    <p class="lead">Aqui você muda  textos das páginas Sobre.</p>
                    ...
                    <section class="s-content s-content--narrow s-content--no-padding-bottom">
                        ...
                        <article class="row format-standard">
                            ...
                            <button id="cadNoticia" type="submit" onclick="AtualizarSobre()">Atualizar</button>
                        </article>
